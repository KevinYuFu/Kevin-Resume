...
\namesection {\hspace{6mm}Yu} {(Kevin) Fu} { % Your name
	\hspace{6mm}\href{kevin.yu.fu@gmail.com} {\textbf{kevin.yu.fu@gmail.com}} | 416-903-2519 \\ % contact information
	\hspace{6mm}\href{https://github.com/yufutotg} {\textbf{github.com/yufutotg}} % Github link
}
...
%
%\fboxsep0pt
\colorbox{background}{\hspace{2mm}\begin{minipage}[t]{0.30\textwidth} % The right column takes up 66% of the text width of the page
\hspace{5mm}
%------------------------------------------------
% Skills
%------------------------------------------------
...
\descript{Fourth Year Computer Science \\ Music Minor}
...
{\addfontfeature{Color=musicheadings}Conductor at St. Cecilia’s Youth Orchestra}\hspace{10mm}2013 - 2016\\
...
{\addfontfeature{Color=musicheadings}Musical Director at UWaterloo A Cappella Club}\hspace{5mm}2016 - 2017\\
