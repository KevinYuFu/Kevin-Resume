...
\namesection {\hspace{6mm}Yu} {(Kevin) Fu} { % Your name
	\hspace{6mm}Kevin.Yu.Fu@gmail.com | 416-903-2519 \\ % contact information
	\hspace{6mm}Github.com/\href{https://github.com/YuFuTotG} {\textbf{YuFuTotG}} % Github link
}
...
{\addfontfeature{Color=musicheadings}Conductor at St. Cecilia’s Youth Orchestra}\\
...
{\addfontfeature{Color=musicheadings}Musical Director at UWaterloo A Cappella Club}\\
